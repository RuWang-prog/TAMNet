...
parser.add_argument("--model_names", default=['VMDNAL'], nargs='+',
...
parser.add_argument("--dataset_names", default=['NUDT-SIRST-Sea'], nargs='+',
...
if __name__ == '__main__':
    ...
    if opt.pth_dirs == None:
        for i in range(len(opt.model_names)):
            ...
            opt.f.write(opt.model_name + '_350.pth.tar' + '\n')
            for dataset_name in opt.dataset_names:
                ...
                opt.pth_dir = opt.save_log + opt.dataset_name + '/' + opt.model_name + '_350.pth.tar'
                ptest()
            print('\n')
            opt.f.write('\n')
        opt.f.close()
